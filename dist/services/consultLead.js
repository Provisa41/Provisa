...
export function formatConsultLeadMessage(lead) {
    const lines = [
    ...
    if (lead.phone)
        lines.push(`📞 Телефон: <code>${lead.phone}</code>`);
    lines.push("", "💬 <b>Сообщение:</b>", lead.topic || "—");
    return lines.join("\n");
}
export async function sendConsultLead(bot, lead) {
...
//# sourceMappingURL=consultLead.js.map